...
struct Constants {
    static let API_KEY = "3145e5b399424ca614b640133e16380b"
    static let baseURL = "https://api.themoviedb.org"
    static let YouTubeAPI_KEY = "AIzaSyBVvhCVzdSilzv5E-JfnXlWV3-RNlK5EFs"
...
class APICaller {
    ...
    func getUpcomingMovies(completion: @escaping (Result<[Title], Error>) -> Void) {
        ...
        print("\(Constants.baseURL)/3/movie/upcoming?api_key=\(Constants.API_KEY)&language=en-US&page=1")
    ...
    func getDiscoverMovies(completion: @escaping (Result<[Title], Error>) -> Void) {
        guard let url = URL(string: "\(Constants.baseURL)/3/discover/movie?api_key=\(Constants.API_KEY)&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_typ=flatrate") else {return}
        let task = URLSession.shared.dataTask(with: URLRequest(url: url)) { data, _, error in
            guard let data = data, error == nil else {
                return
            }
